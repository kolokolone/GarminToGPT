...
export const api = {
  ...
  startMcp: () => request<ActionResult>("/api/mcp/start", { method: "POST" }),
  stopMcp: () => request<ActionResult>("/api/mcp/stop", { method: "POST" }),
  restartMcp: () => request<ActionResult>("/api/mcp/restart", { method: "POST" }),
